        ...
        <div className="py-12 md:py-20">
          ...
          <div className="mx-auto max-w-3xl pb-16 text-center md:pb-20">
            <h2 className="text-3xl font-bold   md:text-4xl">
              BrotoCode helps transform your ideas into high-performance web and
              mobile applications.
            </h2>
          </div>
          {/* Planet */}
          ...
          <div className="grid overflow-hidden sm:grid-cols-2 lg:grid-cols-3 [&>*]:relative [&>*]:p-6 [&>*]:before:absolute [&>*]:before:bg-gray-800 [&>*]:before:[block-size:100vh] [&>*]:before:[inline-size:1px] [&>*]:before:[inset-block-start:0] [&>*]:before:[inset-inline-start:-1px] [&>*]:after:absolute [&>*]:after:bg-gray-800 [&>*]:after:[block-size:1px] [&>*]:after:[inline-size:100vw] [&>*]:after:[inset-block-start:-1px] [&>*]:after:[inset-inline-start:0] md:[&>*]:p-10">
            <article>
              ...
              <p className="text-[15px] text-gray-400">
                Our team of skilled designers crafts visually appealing and
                user-friendly websites that reflect your brand identity. We
                focus on creating intuitive layouts, engaging visuals, and
            ...
            <article>
              ...
              <p className="text-[15px] text-gray-400">
                Our UI/UX design services focus on creating engaging and
                easy-to-navigate interfaces. We conduct thorough user research
                and testing to ensure your app delivers an outstanding user
                experience.
              </p>
            </article>
            <article>
              ...
              <p className="text-[15px] text-gray-400">
                We build websites that are not only beautiful but also robust
                and scalable. Our development team uses the latest technologies
                and best practices to create responsive, high-performance
                websites that deliver a smooth user experience across all
                platforms.
              </p>
            </article>
            <article>
              ...
              <p className="text-[15px] text-gray-400">
                Transform your online store with our custom e-commerce
                solutions. We develop secure, easy-to-manage e-commerce websites
                that offer a seamless shopping experience, complete with payment
                gateway integration, inventory management, and more.
              </p>
            </article>
            ...
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium ">
                ...
                <span>Custom Mobile App Design</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                Our design team creates intuitive and visually appealing mobile
                app interfaces that provide an excellent user experience. We
                focus on user-centric design principles to ensure your app is
            ...
            <article>
              ...
              <p className="text-[15px] text-gray-400">
                Reach a wider audience with our cross-platform app development
                services. We use framework React Native to create apps that run
                seamlessly on both iOS and Android devices, saving you time and
                development costs.
              </p>
            </article>
          </div>
